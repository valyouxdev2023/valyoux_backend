                ...
                <div class="modal-content">
                    <div class="modal-body">
                        <div class="nav flex-sm-column flex-column">
                            ...
                            <a class="nav-item font-weight-700 txt-xl menu-col cursur-pointer" href="{{url('/')}}">Home</a>
                            <a class="nav-item font-weight-700 txt-xl menu-col cursur-pointer" href="{{url('/market')}}">Market</a>
